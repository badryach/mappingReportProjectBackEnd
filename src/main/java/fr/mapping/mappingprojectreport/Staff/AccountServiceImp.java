...
public class AccountServiceImp implements AccountService {
    ...
    public AppUser saveUser(String username, String iris, String password, String confirmedPassword) {
        ...
        if (!iris.equals(staffOptional.getIris()))
            throw new RuntimeException("Le iris saisi n'existe pas dans nos bases. Merci de voir avec un administrateur");
        ...
        } else if (staffOptional.getCodeJob().equals("BITEAM") ) {
